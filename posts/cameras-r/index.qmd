...
author: "Howard Song"
date: "2026-09-23"
description: "Exploring camera sensor sizes and resolution by manufacturer, this time in R."
---
...
We removed `{r} n_removed` cameras with missing sensor measurements.
...
![What were they thinking?](https://www.ephotozine.com/articles/olympus-announce-m-robe---new--musical-memory-maker-concept-1933/images/highres-olympus-m-robe-mr-500ijpg_1556715475.jpg){width=200px}
...
#| fig-width: 9
#| fig-height: 5.5
outliers <- rbind(tiny, medium) |> filter(!is.na(CameraModel))
